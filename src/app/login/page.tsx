...
import { signIn, signInWithGoogle, signInWithApple, signInWithFacebook } from "@/hooks/useAuth"
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/5 to-accent/5 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-heading">Masuk</CardTitle>
          <p className="text-sm text-muted-foreground mt-1">Masuk untuk berbagi pengalaman roadtrip</p>
        </CardHeader>
        <CardContent>
